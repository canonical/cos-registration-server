...
- 🎯 Entry points to execute your program using `python -m <cos_registration_server>` or `$ cos_registration_server` with basic CLI argument parsing.
...
Awesome cos_registration_server created by ubuntu-robotics
